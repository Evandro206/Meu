...
class Conta:
    ...
    @staticmethod
    def findconta(procurado): #Q MERDA TA ACONTECENDO ....................
        for i, contax in enumerate(contas):
            print(procurado,contax.numero) # COMPARACAO QUE VAI SER EXECUTADA.......................
            if procurado == contax.numero:
                print("executa") # TESTE           isso não ta sendo executado mesmo sendo igual(condicao verdadeira)
                return i
            print("não executa") # TESTE isso executa
        return -1
    @staticmethod
    def findcontacpf(procurado):
        a = []
        for i, contax in enumerate(contas):
            if procurado == contax.cliente:                   # é igual
                a.append(i)
        return a                                              # esse funciona o outro nao
    @staticmethod
